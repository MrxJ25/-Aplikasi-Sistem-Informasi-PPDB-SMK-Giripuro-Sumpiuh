...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title"><i class="bx bx-receipt"></i> Edit Berita</h4>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form name="ktg" method="post" action="<?php echo base_url('admin/beritaedit');?>"
                        enctype="multipart/form-data">
                        <fieldset><label>Judul</label>
                            <input type="text" name="judul" maxlength="200" class="form-control" data-validate="required" value="<?php echo $Berita['judul'];?>">
                        </fieldset>

                        <fieldset class="mt-4"><label>Isi Berita</label>
                            <textarea name="isiberita" class="ckeditor"><?php echo stripslashes($Berita['isiberita']);?></textarea>
                        </fieldset>
                            ...
                            <div class="col-sm-3">
                                <fieldset><label>Tampilkan</label>
                                    <select name="aktif" class="form-control">
                                        <option value="Y" <?php if ($Berita['aktif']=='Y') { echo 'selected';}?>>Ya</option>
                                        <option value="T" <?php if ($Berita['aktif']=='T') { echo 'selected';}?>>Tidak</option>
                                    </select>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <fieldset><label>Dibaca</label>
                                    <input type="text" name="dibaca" class="form-control" data-validate="required,number"
                                           value="<?php echo $Berita['dibaca'];?>"/>
                                </fieldset>
                            </div>
                        </div>
                        <fieldset class="mt-4"><label>Gambar kecil (400x200 px, jpg)</label>
                            <input type="file" name="gambarkc" accept="image/jpeg"/>
                            <p><img src="<?php echo base_url();?>img/berita/<?php echo $Berita['idberita'];?>_k.jpg"/></p>
                        </fieldset>
                        <fieldset class="mt-4"><label>Gambar besar (800x600 px, jpg)</label>
                            <input type="file" name="gambarbs" accept="image/jpeg" />
                            <p><img src="<?php echo base_url();?>img/berita/<?php echo $Berita['idberita'];?>_b.jpg"/></p>
                        </fieldset>
