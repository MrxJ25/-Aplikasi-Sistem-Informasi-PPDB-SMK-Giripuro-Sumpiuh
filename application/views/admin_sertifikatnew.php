        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form name="guru" method="post" action="<?php echo base_url('admin/sertifikatnew');?>"
                        enctype="multipart/form-data">
                        <div class="row">
                        <fieldset class="col-sm-6"><label>Nama</label>
                            <input type="text" name="nama" maxlength="30" class="form-control" data-validate="required">
                        </fieldset>
